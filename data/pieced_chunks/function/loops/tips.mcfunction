...
# none
execute at @e[type=marker,tag=pieced_chunloader,tag=!pieced_chunkloader_type_set] as @a[distance=..1.7] run title @s actionbar {"text":"This is an inactive Chunk Loader. Throw Gold, Diamond, or a Nether Star at it to activate. Ignite it to pick up.", color:gold} 
